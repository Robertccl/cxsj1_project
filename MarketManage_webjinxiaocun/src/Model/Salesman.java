...
public class Salesman {
	...
	public Salesman(String number, String name, String gender, String birthDate, String phone, String address,
			String employedDate) {
		super();
		this.number = number;
		this.name = name;
	...
	public Salesman(Integer id, String number, String name, String gender, String birthDate, String phone,
			String address, String employedDate) {
		super();
		this.id = id;
		this.number = number;
		this.name = name;
